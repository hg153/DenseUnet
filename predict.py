...
from datasets import VOCSegmentation, Cityscapes, cityscapes, Crack
...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--input", default = 'datasets/mixed_crack/images', type=str, help="path to a single image or image directory")
    parser.add_argument("--dataset", type=str, default='crack', choices=['voc', 'cityscapes', 'crack'], help='Name of training set')
    parser.add_argument("--threshold", type = float, default = 0.0, help= 'threshold for crack probability')
    ...
    # Train Options
    parser.add_argument("--save_val_results_to", default='test_results', help="save segmentation results to the specified dir")
    ...
    parser.add_argument("--ckpt", default='checkpoints/exp_unet/best_fcn_unet_crack_os16.pth', type=str,  help="resume from checkpoint")
    parser.add_argument("--gpu_id", type=str, default='0', help="GPU ID")
    return parser

def decode_pred(pred, threshold):
    pred[pred<threshold]
